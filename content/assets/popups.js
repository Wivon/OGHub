 ...
 */
function openPopup(text, blur = true, buttonsHTML='<button onclick="hidePopup()" class="Popupbutton">Cancel</button><hr><button class="Popupbutton">Confirm</button>', imageParams={"path": 'img/close_icon.png', "invert": true}) {
